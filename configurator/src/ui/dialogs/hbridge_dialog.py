...
class HBridgeDialog(QDialog):
    ...
    def _create_control_group(self) -> QGroupBox:
        ...
        self.source_channel_btn = QPushButton("Browse...")
        ...
        self.direction_source_btn = QPushButton("Browse...")
    ...
    def _create_position_group(self) -> QGroupBox:
        ...
        self.position_source_btn = QPushButton("Browse...")
        ...
        self.target_source_btn.setMaximumWidth(30)
    ...
    def _create_stall_group(self) -> QGroupBox:
        ...
        self.stall_current_spin.setDecimals(1)
